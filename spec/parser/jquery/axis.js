...
describe("Axis parsing", function () {
    ...
    describe("Binding parsing", function () {
        ...
        it("should properly parse axis models from XML with binding child tags", function () {
            expect(axis.binding().id()).toEqual(idString);
            expect(axis.binding().min()).toEqual(minString);
            expect(axis.binding().max()).toEqual(maxString);
        });
